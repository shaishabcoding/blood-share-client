...
const Request = () => {
  ...
  return (
    <div className="w-full lg:p-6 px-2 lg:mx-0 lg:rounded-lg lg:my-6 my-1 py-6">
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:my-10 md:gap-4 px-3 my-6 gap-6 lg:px-0">
